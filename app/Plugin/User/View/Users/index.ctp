<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('jrr_user'); ?></th>
			<th><?php echo $this->Paginator->sort('jrr_password'); ?></th>
			<th><?php echo $this->Paginator->sort('default_password'); ?></th>
			<th><?php echo $this->Paginator->sort('rxt'); ?></th>
			<th><?php echo $this->Paginator->sort('is_login'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['jrr_user']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['jrr_password']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['default_password']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['rxt']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['is_login']); ?>&nbsp;</td>
