<div class="accountTypes index">
	...
	<tr>
		...
		<td><?php echo h($accountType['AccountType']['modified_by']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $accountType['AccountType']['id']), array(), __('Are you sure you want to delete # %s?', $accountType['AccountType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
