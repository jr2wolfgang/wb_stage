...
<div class="clear"></div>
<?php echo $this->Form->create('User',array('class'=>'form-horizontal ads','role'=>'form','url'=>array('controller' => 'users','action' => 'edit'))); ?>
	
	<?php  echo $this->Form->input('id',array('label' => false,'class' => 'required')); ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<?php echo $this->Form->input('jrr_password'
			,array(
			'type' => 'password',
			'label' => false,
			'class' => 'required',
			'value' => $this->request->data['User']['rxt']
			)); ?>
		</div>
	</div>
