    ...
    e.fn.uploadFile = function(n) {
        ...
        function f(t, n, r) {
            r.on("dragenter", function(t) {
                t.stopPropagation();
                t.preventDefault();
                e(this).css("borderx", "2px solid #A5A5C7")
            });
            ...
            r.on("drop", function(r) {
                e(this).css("borderx", "2px dotted #A5A5C7");
                r.preventDefault();
                t.errorLog.html("");
            ...
            e(document).on("dragover", function(e) {
                e.stopPropagation();
                e.preventDefault();
                r.css("borderx", "2px dotted #A5A5C7")
            });
        ...
        var r = e.extend({
            ...
            uploadButtonClass: "ajax-file-upload ajax-file-upload-main-btn btn btn-warning",
            dragDropStr: '<div class="form-group"><div class="col-xs-12"><label class="ace-file-input ace-file-multiple"><input type="file" multiple="" id="id-input-file-3"><span class="ace-file-container" data-title="Drop files here or click to choose"><span class="ace-file-name" data-title="No File ..."><i class=" ace-icon ace-icon fa fa-cloud-upload"></i></span></span><a class="remove" href="#"><i class=" ace-icon fa fa-times"></i></a></label></div></div>',
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
